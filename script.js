...
function creerResto (titre, imageURL, description,prix, distance,lien, indexResto){
    ...
    linkGridResto.classList.add("boutonResto");
    linkGridResto.setAttribute("id",indexResto);
